    ...
    <footer id="contact" className="bg-zinc-950 border-t border-zinc-900 pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          <div>
            <h4 className="text-2xl font-bold text-white mb-4">Tejgaon College Photography Club</h4>
          ...
          <div>
            <h5 className="text-white font-bold mb-4 uppercase tracking-wider text-sm">Follow Us</h5>
