      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <div className="flex flex-col items-center mb-0">
          ...
          <img 
            ...
            className="w-[85%] max-w-md md:max-w-xl mb-0 mt-0 object-contain animate-fade-in-up"
          />
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          <a 
            ...
            className="group px-6 py-3 bg-gold-500 text-black font-bold text-base rounded-full hover:bg-white transition-all flex items-center gap-2"
          >
            Submit Your Photos
