    ...
    <section id="submission" className="py-20 bg-zinc-900">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">Submission & Payment</h2>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              {[
                ...
                <li key={idx} className="flex items-start gap-3 text-zinc-300 bg-zinc-950/50 p-4 rounded-lg border border-zinc-800">
          ...
          <div className="glass-card p-8 rounded-2xl border border-gold-500/20 relative overflow-hidden">
            ...
            <div className="bg-pink-600/90 p-6 rounded-xl text-white mb-8 shadow-lg">
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium opacity-90">bKash Send Money</span>
                <Send className="w-5 h-5 opacity-90" />
              </div>
              <div className="text-3xl font-sans font-bold tracking-wider mb-2">
                {BKASH_NUMBER}
              </div>
              <button 
                onClick={copyNumber}
                className="flex items-center gap-2 text-sm bg-black/20 hover:bg-black/30 px-3 py-1.5 rounded transition-colors"
              >
            ...
            <div className="text-center">
              ...
              <a 
                ...
                className="block w-full py-4 bg-white text-black font-bold text-lg rounded-xl hover:bg-gold-400 transition-colors"
              >
